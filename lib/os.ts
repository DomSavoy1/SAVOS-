...
export const seedState:OSState={
 ventures:[
  {id:"catalog-rescue",name:"Savoy Catalog Rescue",stage:"Validation",status:"yellow",problem:"Retail launches delayed by inconsistent supplier catalog data.",offer:"A bounded catalog cleanup pilot with change log and exception report.",recurring:false,score:5,nextAction:"Confirm capacity, then approve or reject a 20-prospect validation sprint.",revenue:0,hours:0},
 ...
 missions:[{id:"fm-capacity",title:"Set founder operating constraints",ventureId:"portfolio",type:"Capital allocation",priority:"high",status:"queued",reason:"Capacity, budget, jurisdiction, and the definition of the $1,000 weekly target are unknown.",roi:"Prevents selecting a venture the founder cannot sustainably deliver.",risk:"Without constraints, economics remain hypothetical.",alternative:"Run one tightly capped five-hour discovery sprint.",confidence:95,createdAt:now}],
 ledger:[],logs:[{id:"log-import",at:now,actor:"Jamal",action:"Imported Catalog Rescue and Reporting Desk as proposed ventures.",reason:"Existing research is useful context; neither venture is validated or profitable.",reversible:true}],
 knowledge:[{id:"constitution",type:"Principle",title:"SVOS Constitution v1.0",summary:"Build ethical, recurring, standardized ventures that reduce founder work and compound reusable assets.",updatedAt:now},{id:"catalog-kit",type:"Playbook",title:"Catalog Rescue Pilot Launch Kit",summary:"$250 proposed pilot, up to 25 records, one revision, documented QA and exception handling.",ventureId:"catalog-rescue",updatedAt:now},{id:"venture-lifecycle",type:"SOP",title:"Venture Creation Lifecycle",summary:"Capture, research, validate, filter, design, build, acquire, measure, document, automate, scale, repeat.",updatedAt:now}],
 agents:[
